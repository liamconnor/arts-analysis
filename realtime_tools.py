...
class RealtimeProc:
    ...
    def dedisperse(self, data, dm, freq=(1550, 1250), freq_ref=None, dt=8.192e-5):
    ...
    def dedisperse_tabs(self, data, dm, dt=8.192e-5, freq=(1550, 1250), freq_ref=None):
        ...
        for tab in range(ntab):
            data[tab] = self.dedisperse(data[tab], dm, freq=freq, freq_ref=freq_ref, dt=dt)
